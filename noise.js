...
(function(global){
  ...
  // fractal noise using simplex3 (made by johnnyboy)
  module.fractal3 = function(x, y, z, octaves, frequency, persistence = 0.5, lacunarity = 2.0){
    var total = 0;
    var amplitude = 1;
  ...
  // if x <= low return 0
  // if x >= high return 1
  // else return value between 0-1 based on ratio
  module.cblend = function(x, low, high){
